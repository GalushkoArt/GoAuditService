...
const (
	LogRequest_SIGN_UP LogRequest_Actions = 0
	LogRequest_SIGN_IN LogRequest_Actions = 1
	LogRequest_REFRESH LogRequest_Actions = 2
	LogRequest_GET     LogRequest_Actions = 3
	LogRequest_CREATE  LogRequest_Actions = 4
	LogRequest_UPDATE  LogRequest_Actions = 5
...
const (
	...
	LogRequest_SYMBOL LogRequest_Entities = 1
)
...
type Response_Answer int32

const (
	Response_SUCCESS Response_Answer = 0
	Response_ERROR   Response_Answer = 1
)

// Enum value maps for Response_Answer.
var (
	Response_Answer_name = map[int32]string{
		0: "SUCCESS",
		1: "ERROR",
	}
	Response_Answer_value = map[string]int32{
		"SUCCESS": 0,
		"ERROR":   1,
	}
)

func (x Response_Answer) Enum() *Response_Answer {
	p := new(Response_Answer)
	*p = x
	return p
}

func (x Response_Answer) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Response_Answer) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_audit_proto_enumTypes[2].Descriptor()
}

func (Response_Answer) Type() protoreflect.EnumType {
	return &file_proto_audit_proto_enumTypes[2]
}

func (x Response_Answer) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Response_Answer.Descriptor instead.
func (Response_Answer) EnumDescriptor() ([]byte, []int) {
	return file_proto_audit_proto_rawDescGZIP(), []int{1, 0}
}
...
type Response struct {
	...
	Answer Response_Answer `protobuf:"varint,1,opt,name=answer,proto3,enum=audit.Response_Answer" json:"answer,omitempty"`
}
...
func (x *Response) GetAnswer() Response_Answer {
	if x != nil {
		return x.Answer
	}
...
var file_proto_audit_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xea, 0x02, 0x0a, 0x0a,
	...
	,
...
var file_proto_audit_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
...
var file_proto_audit_proto_goTypes = []interface{}{
	...
	(Response_Answer)(0),        // 2: audit.Response.Answer
	(*LogRequest)(nil),          // 3: audit.LogRequest
	(*Response)(nil),            // 4: audit.Response
...
var file_proto_audit_proto_depIdxs = []int32{
	...
	5, // 2: audit.LogRequest.timestamp:type_name -> google.protobuf.Timestamp
	2, // 3: audit.Response.answer:type_name -> audit.Response.Answer
	3, // 4: audit.AuditService.Log:input_type -> audit.LogRequest
	4, // 5: audit.AuditService.Log:output_type -> audit.Response
